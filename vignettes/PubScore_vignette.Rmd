...
```{r}
literature_object <- PubScore::get_literature_score(selected_genes, terms_of_interest = terms_of_interest, is.list = T)
...
total_genes,                                                          remove_ambiguous = T)
...
```{r}
p <- PubScore::plot_literature_score(literature_object_tested$counts, return_ggplot = T)
library(plotly)
ggplotly(p)
```
#Advanced Usage
